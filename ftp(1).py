...
def save_file(con: FTP, remote_file_path: str, local_file_path: str):
    with open(local_file_path, "wb") as local_file:
        con.retrbinary(f"RETR{remote_file_path}", local_file_path.write)
...
def connect_ftp(
    ...
    for file_info in l_file:
        file_name = get_file_name(files_info)
        print(file_name)
...
if __name__ == "__main__":
    connect_ftp(host="ftp.mirror.nl", save_path="/home/esteban/txt")
